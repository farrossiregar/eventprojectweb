            ...
            <div class="row">
                ...
                <div class="col-md-10">
                        ...
                        <div class="col-md-2">
                            ...
                            <div class="btn-group" role="group">
                                ...
                                <div class="dropdown-menu" aria-labelledby="btnGroupDrop1">
                                    <a href="javascript:void(0)" id="card-btn-catalog" class="dropdown-item"><i class="fa fa-square-o"></i> Card</a>
                                    <a href="javascript:void(0)" id="list-btn-catalog" class="dropdown-item"><i class="fa fa-list-ul"></i> List</a>
                                </div>
                            </div>
                            <span wire:loading>
                    ...
                    <div class="body pt-0">
                        ...
                        <div class="row" id="card-view-catalog" style="display: none;">
                            <?php for($i = 0; $i<6; $i++){ ?>
...
<script>
    $('#card-btn-catalog').on('click', function(){
        $('#card-view-catalog').css('display','block');
        $('#list-view-catalog').css('display','none');
    });

    $('#list-btn-catalog').on('click', function(){
        $('#card-view-catalog').css('display','none');
        $('#list-view-catalog').css('display','block');
    });
</script>
