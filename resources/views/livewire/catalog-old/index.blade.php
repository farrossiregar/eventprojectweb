                ...
                <div class="col-md-2">
                    ...
                    <div class="btn-group" role="group">
                        ...
                        <div class="dropdown-menu" aria-labelledby="btnGroupDrop1">
                            <a href="javascript:void(0)" class="dropdown-item"><i class="fa fa-square-o"></i> Card</a>
                            <a href="javascript:void(0)" class="dropdown-item"><i class="fa fa-list-ul"></i> List</a>
                        </div>
                    </div>
                    <span wire:loading>
