<div class="editable">
    @if($is_edit)
        ...
        @if($field=='product_uom_id')
            <select class="form-control" wire:model="value" style="height:30px; width: 100px;">
        ...
        @elseif($field=='tanggal_lahir')
            <input type="date" class="form-control" style="height:30px; width: 100px;" wire:model="value" wire:keydown.enter="save" placeholder="{{$field}}"  />
        @elseif($field=='type')
            <select class="form-control" wire:model="value" style="height:30px; width: 100px;">
        ...
        @else
            <input type="text" class="form-control" style="height:30px; width: 100px;" wire:model="value" wire:keydown.enter="save" placeholder="{{$field}}"  />
        @endif
